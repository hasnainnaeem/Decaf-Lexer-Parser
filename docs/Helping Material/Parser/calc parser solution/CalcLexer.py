...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write(";\5\2\13\f\17\17\"\"\2B\2\3\3\2\2\2\2\5\3\2\2\2\2\7\3")
...
class CalcLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "ADD", "SUB", "MULT", "DIVIDE", "EQUALS", "SEMICOLON", "LBRACE", 
            "RBRACE", "VAR", "NUMBER", "WS" ]

    ruleNames = [ "ADD", "SUB", "MULT", "DIVIDE", "EQUALS", "SEMICOLON", 
                  "LBRACE", "RBRACE", "ALPHA", "VAR", "DIGIT", "NUMBER", 
                  "WS" ]
